...
(function() {
  ...
  var URL = window.UEDITOR_HOME_URL || getUEBasePath();//"http://localhost:8080/static/utf8-jsp/"
  var serverURL="";
  if(strPath.indexOf("weixinMediaArticle/add")!=-1){
	  serverURL = prePath+"/center/ueditor/weixinUpload";
  }else{
	  serverURL = prePath+"/center/ueditor/upload";
  }
  /**
