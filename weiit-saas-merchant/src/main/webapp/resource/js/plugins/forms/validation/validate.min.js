...
function(a) {
    ...
    a.extend(a.validator, {
        ...
        messages: {
            ...
            creditcard: "请输入正确的卡号!",
            equalTo: "两次输入的不同!",
            maxlength: a.validator.format("输入字符不能超过 {0} 个字符！"),
            minlength: a.validator.format("输入字符不能少于 {0} 个字符！"),
            rangelength: a.validator.format("请输入长度必须介于 {0} 和  {1} 之间的字符串。"),
            range: a.validator.format("输入值必须介于 {0} 和  {1} 之间。"),
            max: a.validator.format("输入值不能大于 {0}。"),
            min: a.validator.format("输入值不能小于 {0}。")
        },
        autoCreateRanges: !1,
        prototype: {
            init: function() {
