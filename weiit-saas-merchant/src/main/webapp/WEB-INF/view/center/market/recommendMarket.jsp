					...
					<div class="sidebar-category">
						...
						<div class="category-content no-padding">
							<ul class="navigation navigation-alt navigation-accordion">
								<li><a href="onSaleList"><i class="icon-price-tag3"></i>出售中的商品</a></li>
								<li><a href="soldOutList"><i class="icon-flag3"></i>库存紧张商品</a></li>
								<li><a href="forSaleList"><i class="icon-make-group"></i>仓库中的商品</a></li>
								<li><a href="#"><i class="icon-import"></i> 商品导入</a></li>
			...
			<div class="content-wrapper">
				...
				<div class="content">
					...
					<ul class="nav nav-lg nav-tabs nav-tabs-bottom search-results-tabs">
						<li><a href="jdMarket" class="btn border-primary text-primary btn-flat btn-rounded btn-icon btn-sm"><img src="http://member.koudaiqifu.cn/statics/img/tab_icon/jd.png" alt="">京东商品</a></li>
						...
						<li class="active"><a href="recommendMarket" class="btn border-primary text-primary btn-flat btn-rounded btn-icon btn-sm"><img src="http://member.koudaiqifu.cn/statics/img/tab_icon/jx.png" alt=""> 精选商品</a></li> 
					</ul>
					<!-- /tabs -->
					<!-- Search field -->
							...
							<table id="data-table" class="table">
								...
								<tbody>
										<tr>
											...
											<td>
												<img src="http://img.packeding.cn/4b23668d2c33329c48caad05d4a2867c?x-oss-process=image/quality,q_80" width="80px" height="80px">
												 「江南雅韵牌」阳澄湖大闸蟹1598型礼盒套餐（4.0两公蟹*5只 2.8两母蟹*5只）
											</td>
											<td>¥21.60</td>
											<td>¥21.17</td>
											<td>300</td>
										...
										<tr>
											<td><input type="checkbox" name="ids" value=""></td>
											<td>
												<img src="http://img.packeding.cn/243170baa81101a8ae43222e6a8c2180?x-oss-process=image/quality,q_80" width="80px" height="80px">
												 秋膏蟹业 阳澄湖大闸蟹2688型【公蟹：4.0两 、母蟹：3.0两 5对】
											</td>
											<td>¥21.60</td>
											<td>¥21.17</td>
											<td>300</td>
