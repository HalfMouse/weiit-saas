...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resource/css/minified/bootstrap.min.css">
    ...
    <script src="${pageContext.request.contextPath}/resource/js/core/libraries/jquery.min.js"></script>
    <style>
        .no-have {
            position: absolute;
            color: #f44;
