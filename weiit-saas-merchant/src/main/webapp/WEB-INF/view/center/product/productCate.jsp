		...
		<div class="sidebar-category">
			...
			<div class="category-content no-padding">
				<ul class="navigation navigation-alt navigation-accordion">
					...
					<li class="active"><a href="${pageContext.request.contextPath}/center/productCate/list"><i class="icon-chess"></i> 商品分类</a></li>
					<li><a href="${pageContext.request.contextPath}/center/productTag/list"><i class="icon-chess"></i> 商品分组</a></li>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form class="form-horizontal form-validate-jquery" name="infoform" id="infoform"
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							<input type="text" class="form-control" name="cate_name"
								id="cate_name" value="" required="required">
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input type="text" class="form-control" name="sort_num"
								id="sort_num" value="0" digits="true" required="required">
						</div>
					</div>
					<div class="form-group">
