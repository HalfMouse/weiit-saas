...
<%@include file="../common/header.jsp" %>
		<script type="text/javascript" charset="utf-8" src="${pageContext.request.contextPath}/resource/js/neditor/neditor.config.js"></script>
   		<script type="text/javascript" charset="utf-8" src="${pageContext.request.contextPath}/resource/js/neditor/neditor.all.js"> </script>
				...
				<ul class="nav nav-pills col-sm-12  alert-primary">
					<li class="col-sm-3 text-center">
						<span  style="color:black;"> 1.选择商品品类
							...
							<i class="icon-arrow-right15 position-right"></i></span>
					</li>
					<li class="col-sm-3 text-center">
						<a href="javascript:;" onclick="secondStep();"> 2.编辑基本信息
							<i class="icon-arrow-right15 position-right"></i>
							<i class="icon-arrow-right15 position-right"></i></a>
					</li>
					<li class="active col-sm-3 text-center">
						<a href="javascript:;" > 3.编辑商品详情
							<i class=" icon-check position-right"></i></a>
					</li>
				</ul>
					...
					<div id="wizard" class="bwizard clearfix">
						...
						<ul class="pager bwizard-buttons">
							 <li class="previous " role="button" aria-disabled="true">
		                        <a href="javascript:;"  onclick="secondStep();">← 上一步</a>
							 </li>
		                     <li class="next" id="buttonli"  role="button" aria-disabled="false">
		                       <a href="javascript:;" id="buttonsave" onclick="saveProduct();">完成保存</a>
							 </li>
						</ul>
					</div>
				</form>
...
function checkStep11(){
	  $('#form-wizard').attr("action", "${pageContext.request.contextPath}/center/product/releaseOne?oneflag=1" );
	  $("#form-wizard").submit();
}
...
function saveProduct(){
	  ...
	  $('#form-wizard').attr('action', '${pageContext.request.contextPath}/center/product/save'  );
	  $("#form-wizard").submit();
}
</script>