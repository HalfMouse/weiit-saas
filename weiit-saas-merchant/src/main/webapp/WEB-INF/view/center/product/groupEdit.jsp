...
<form class="form-horizontal"  name="infoForm" id="infoForm" target="rightIframe"
	action="${pageContext.request.contextPath}/center/productGroup/save" method="post" >
				...
				<div class="panel panel-flat"> 
					...
					<fieldset class="content-group">
						<div class="form-group">
							<label class="control-label col-xs-3 text-bold text-right"><font color="red"> * </font>分组名称:</label>
							<div class="col-xs-6">
								<div class="input-group">
									<input type="text" class="form-control validate[required]" name="group_name" id="group_name" 
										data-errormessage-value-missing="分组名称不能为空" placeholder="请输入分组名称" value="${infoMap.group_name}"> 
								</div>
							</div>
						</div>
						<div class="form-group">
